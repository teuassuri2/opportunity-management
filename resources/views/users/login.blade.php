    ...
    <body class="text-center">
        ...
        <main class="form-signin w-100 m-auto">
            ...
            <form method="POST" action="{{route('auth_login')}}">
                @csrf
                <img class="mb-4" src="https://www.vitaminaweb.com.br/wp-content/uploads/2022/05/logo_vitaminaweb-300x124_novo.png" alt="">
                <h1 class="h3 mb-3 fw-normal">Informe seus dados de acesso</h1>
                ...
                <p class="mt-5 mb-3 text-muted">&copy; @teuassuri</p>
            </form>
        </main>
