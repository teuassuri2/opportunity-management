...
class TypesUsersController extends Controller {
    ...
    public function storeApi(StoreTypesUsersRequest $request) {
        if ($request->isMethod("post")) {
            $typesUsers = $this->typesUsersService->store($request->validated());
            return response()->json(new TypesUsersJsonResource($typesUsers), 200);
        }
    }

    public function editApi(TypesUsers $typesUsers, StoreTypesUsersRequest $request) {
        if ($request->isMethod("post")) {
            $typesUsers = $this->typesUsersService->update($typesUsers, $request->validated());
            return response()->json(new TypesUsersJsonResource($typesUsers), 200);
        }
    }

    public function store(StoreTypesUsersRequest $request) {
        if ($request->isMethod("post")) {
            $typesUsers = $this->typesUsersService->store($request->validated());
        }
    ...
    public function edit(TypesUsers $typesUsers, StoreTypesUsersRequest $request) {
        if ($request->isMethod("post")) {
            $typesUsers = $this->typesUsersService->update($typesUsers, $request->validated());
        }
    ...
    public function deleteApi(int $id) {
        if ($request->isMethod("post")) {
            $this->typesUsersService->delete($id);
