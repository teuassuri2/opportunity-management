...
class OpportunitysStatusController extends Controller {
    ...
    public function storeApi(StoreOpportunitysStatusRequest $request) {
        if ($request->isMethod("post")) {
            $opportunitysStatus = $this->opportunitysStatusService->store($request->validated());
            return response()->json(new OpportunitysStatusJsonResource($opportunitysStatus), 200);
        }
    }

    public function editApi(OpportunitysStatus $opportunitysStatus, StoreOpportunitysStatusRequest $request) {
        if ($request->isMethod("post")) {
            $opportunitysStatus = $this->opportunitysStatusService->update($opportunitysStatus, $request->validated());
            return response()->json(new OpportunitysStatusJsonResource($opportunitysStatus), 200);
        }
    }

    public function store(StoreOpportunitysStatusRequest $request) {
        if ($request->isMethod("post")) {
            $opportunitysStatus = $this->opportunitysStatusService->store($request->validated());
        }
    ...
    public function edit(OpportunitysStatus $opportunitysStatus, StoreOpportunitysStatusRequest $request) {
        if ($request->isMethod("post")) {
            $opportunitysStatus = $this->opportunitysStatusService->update($opportunitysStatus, $request->validated());
        }
    ...
    public function deleteApi(int $id) {
        if ($request->isMethod("post")) {
            $this->opportunitysStatusService->delete($id);
