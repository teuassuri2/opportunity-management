<?php  namespace App\Services; use App\Models\Users; class UsersService {  private Users $users;public function __construct(Users $users)
    {
        $this->users = $users;
    }public function store(array $data){ $this->users->name = $data['name'];
 ...
 $this->users->save();
 return $this->users;
}public function update(Users $users, array $data){ $users->name = $data['name'];
