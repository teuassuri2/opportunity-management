<?php  namespace App\Services; use App\Models\Opportunitys; class OpportunitysService {  private Opportunitys $opportunitys;public function __construct(Opportunitys $opportunitys)
    {
        $this->opportunitys = $opportunitys;
    }public function store(array $data){ $this->opportunitys->title = $data['title'];
...
}public function update(Opportunitys $opportunitys, array $data){ $opportunitys->title = $data['title'];
